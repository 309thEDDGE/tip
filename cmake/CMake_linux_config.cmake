...
add_definitions(
    ...
    -DTRANSLATE_1553_LOGNAME="${TRANSLATE_1553_LOGNAME}"
    -DTRANSLATE_429_LOGNAME="${TRANSLATE_429_LOGNAME}"
    -DCH10_PARSE_LOGNAME="${CH10_PARSE_LOGNAME}"
    -D__linux__
    -DPARQUET_STATIC
    -DARROW_STATIC
)
...
if("${USER_INSTALL_DIR}" STREQUAL OFF)
