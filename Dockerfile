FROM registry1.dso.mil/ironbank/opensource/metrostar/tip-dependencies:0.0.6 AS tipdependencies
# FROM registry1.dso.mil/ironbank/opensource/metrostar/pytorch:1.11.0 AS pytorch
FROM registry1.dso.mil/ironbank/opensource/metrostar/singleuser:singeluser_v12 AS singleuser
...
RUN rm -rf /opt/conda/pkgs/future-0.18.2-py39hf3d152e_4/lib/python3.9/site-packages/future/backports/test/badcert.pem \
    ...
    && rm -rf /opt/conda/pkgs/tornado-6.2-py39hb9d737c_0/lib/python3.9/site-packages/tornado/test/test.key
