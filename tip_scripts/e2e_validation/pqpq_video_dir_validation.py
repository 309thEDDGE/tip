from tip_scripts.e2e_validation.pqpq_raw1553_validation import PqPqVideoValidation
...
class PqPqVideoDirValidation(DirectoryValidation):
    ...
    def __init__(self, truth_path, test_path, pqcompare_exec_path, bincompare_exec_path):
        DirectoryValidation.__init__(self, 'PqPqVideoDirValidation')
    ...
    def _create_validation_objects(self):
        ...
        self.validation_objects.append(
            PqPqVideoValidation(self.truth_path, self.test_path, self.pqcompare_exec_path))
