...
#define REGISTER_TRANSLATE_TYPE(X) \
    template <> const char* ICDTranslate::TypeTranslateTraits<X>::name = #X
...
ICDTranslate::ICDTranslate() : n_translated_values_(0), downshift1_(0), downshift2_(0),
	mask1_(0), mask1_twos_(0), mask2_(0), mask2_twos_(0), scale_(0.0), scale_twos_(0.0),
	elem_word_count_(0), should_resize_output_vector_(true), sign_bit_mask_(0)
{
