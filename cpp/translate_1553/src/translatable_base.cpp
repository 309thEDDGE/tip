...
arrow_type_(arrow_type), append_count_(0), raw_data_ptr_(nullptr), raw_data_ref_(raw_data_), 
have_set_memory_location_(false), translated_data_append_count_(0), icd_elem_ptr_(icd_elem_ptr),
col_name_("")
{ 
...
TranslatableBase::TranslatableBase(std::string& col_name, bool is_ride_along, 
	std::shared_ptr<arrow::DataType> arrow_type) : is_ride_along_(is_ride_along),
arrow_type_(arrow_type), col_name_(col_name), append_count_(0),
raw_data_ptr_(nullptr), raw_data_ref_(raw_data_), have_set_memory_location_(false),
