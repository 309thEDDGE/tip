...
uint8_t ParquetTranslationManager::consume_row_group()
{
    ...
    // TODO(ijmeyers): set column index in a dynamic way using the schema from arrow_table.
...
#if DEBUG > 0
            printf(
                "ParquetTranslationManager::build_select_messages_indices_set(): "
