    ...
    std::string& output_path_str)
{
    ...
    std::string description = "Create Transport Stream (TS) files from \"Video "
        "Data, Format 0\" intermediate parquet files generated by tip parse. "
        "Output TS files will be labeled \"video_channel_id_XX.ts\", "
        "in which XX is the channel ID given in the video packet header and to which all video data "
        "in a specific video file will be relevant. TS files will be placed "
        "in a directory with the name \"<ch10 name>_VIDEO_DATA_F0_TS\" at the location of the output directory.";
    ...
    std::string input_pq_dir_help = "Path to directory of video format 0 data in Parquet format. "
        "These data are the output of tip parse if \"Video Data, Format 0\" packets are present in the "
