...
class TMATSParser
{
    ...
    */
    ...
    /*
    Parse PCM_F1-relevant TMATs data.

    Args:
        uni_map     --> unilateral_map of pcm index to a map of 
                        tmats code string to string value of tmats
                        attribute
        req_attrs   --> Set of strings of required attributes
        opt_attrs   --> Set of strings of optional attributes

    Return:
        False if a regex can't be generated by the underlying TMATSParser
        (likely due to an invalid attribute value), or if one of the
        required attributes can't be found for each PCM tmats index.
        Otherwise true. 
    */
    bool ParsePCMF1Data(unilateral_map& uni_map, 
