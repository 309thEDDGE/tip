...
TEST_F(CLIGroupTest, ParseFailNotConfigured)
{
    ...
    ASSERT_EQ(70, cli_group_.Parse(argc, argv, cli_nickname_, active_cli));
}
...
TEST_F(CLIGroupTest, ParseFailNotPresent)
{
    ...
    cli_nickname_ = "";
    std::shared_ptr<CLIGroupMember> active_cli;
    ASSERT_EQ(64, cli_group_.Parse(argc, argv, cli_nickname_, active_cli));
}
...
TEST_F(CLIGroupTest, ParsePassIndicatorPresent)
{
    ...
    cli_nickname_ = "";
    std::shared_ptr<CLIGroupMember> active_cli;
    ASSERT_EQ(0, cli_group_.Parse(argc, argv, cli_nickname_, active_cli));
