    ...
    const std::string& high_level_description)
{
    ...
    cli->AddOption("input_data", input_parsed_data_help, config.input_data_path_str_, true);
    cli->AddOption("input_dts", input_dts429_help, config.input_dts_path_str_, true);
